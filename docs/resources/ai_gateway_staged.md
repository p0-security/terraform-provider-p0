...
page_title: "p0_ai_gateway_staged Resource - p0"
subcategory: ""
description: |-
  A staged installation of an AI gateway.
...
- `url` (String) AI gateway URL; your servers will be hosted here.
