...
page_title: "p0_ai_gateway Resource - p0"
subcategory: ""
description: |-
  Final installation of an AI gateway, which hosts MCP servers and applies P0 access
...
- `id` (String) The `id` of the `p0_ai_gateway_staged` resource being finalized
