...
page_title: "p0_ai_gateway_server Resource - p0"
subcategory: ""
description: |-
  Registers an MCP server behind an AI gateway, giving agents access to your resources.
...
- `gateway` (String) The `id` of the `p0_ai_gateway` that hosts this server
