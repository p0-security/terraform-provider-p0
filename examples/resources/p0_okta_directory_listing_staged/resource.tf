# Stage the Okta directory-listing installation. P0 generates a JWK, exported
# as the computed `jwk` attribute, which authenticates the Okta service app.
resource "p0_okta_directory_listing_staged" "example" {
  domain = "example.okta.com"
}

# Create the Okta service app that P0 uses to read the directory. Its JWKS is
# populated from the JWK generated by the staged resource above.
